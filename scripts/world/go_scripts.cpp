...
{
    if (pPlayer->HasSkill(SKILL_ENGINEERING) && pPlayer->GetBaseSkillValue(SKILL_ENGINERING) >= 300 && !pPlayer->HasSpell(SPELL_ENGINEER_FIELD_REPAIR_BOT_74A))
...
void AddSC_go_scripts()
{
    ...
    pNewScript = new Script;
    pNewScript->Name = "go_shaffars_stasis";
    pNewScript->pGOHello =           &GOHello_go_shaffars_stasis;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "go_mana_tomb_stasis";
    pNewScript->pGOHello =           &GOHello_go_mana_tomb_stasis;
    pNewScript->RegisterSelf();

    pNewScript = new Script;
    pNewScript->Name = "go_zuluheds_chain";
    pNewScript->pGOHello =           &GOHello_go_zuluheds_chain;
    pNewScript->RegisterSelf();    
