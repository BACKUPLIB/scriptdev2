/*          Nargle Lashcord
    ...
    3.0.1 -> No Vendor?
*/
DELETE FROM `creature` where `id` IN (33927, 33921, 31863);
...
/*          Xazi Smolderpipe
    ...
    3.0.1 -> No Vendor?
*/
DELETE FROM `creature` where `id` IN (33926, 33922, 31864);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Zom Bocom
    ...
    3.0.1 -> No Vendor?
*/
DELETE FROM `creature` where `id` IN (33925, 33923, 31865);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
*/
DELETE FROM `creature` where `id` IN (34092, 34087);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
*/
DELETE FROM `creature` where `id` IN (33940, 33918, 32356);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Leeni "Smiley" Small
    ...
    2.3.0 -> s3
*/
DELETE FROM `creature` where `id` IN (33941, 33919, 32354);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Argex Irongut
    ...
    3.0.2 -> s5, and another version as non-vendor
*/
DELETE FROM `creature` where `id` IN (33924, 33915, 32359);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Ecton Brasstumbler
    ...
    2.3.0 -> s3
*/
DELETE FROM `creature` where `id` IN (33929, 33917, 32360);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
*/
DELETE FROM `creature` where `id` IN (34083, 34082, 32834);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Blood Guard Zar'shie
    ...
    3.0.3 -> "even lower s5" :-P (Savage Gladiator)
*/
DELETE FROM `creature` where `id` IN (34062, 34061, 32832);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Lieutenant Tristia
    ...
    3.0.2 -> s5
*/
DELETE FROM `creature` where `id` IN (34077, 34076, 32380);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Captain Dirgehammer
    ...
    3.0.2 -> "lower s5" (Hateful Gladiator)
*/
DELETE FROM `creature` where `id` IN (34074, 34073, 32381);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Doris Volanthius
    ...
    3.0.2 -> s5
*/
DELETE FROM `creature` where `id` IN (34059, 34058, 32385);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
...
/*          Sergeant Thunderhorn
    ...
    3.0.2 -> "lower s5" (Hateful Gladiator)
*/
DELETE FROM `creature` where `id` IN (34037, 34036, 32383);
INSERT INTO `creature` (guid, id, map, spawnMask, phaseMask, modelid, equipment_id, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, currentwaypoint, curhealth, curmana, DeathState, MovementType) VALUES
