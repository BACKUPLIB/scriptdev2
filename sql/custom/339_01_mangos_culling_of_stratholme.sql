...
DELETE FROM gameobject_template WHERE entry=250200;
INSERT INTO gameobject_template (entry, type, displayId, name, data0, data1, data3, data11, data12, data13, data15) VALUES 
	(250200, 3, 1387, 'Dark Runed Chest', 1634, 24556, 1, 1, 1, 1, 1);

DELETE FROM gameobject WHERE guid=67603;
