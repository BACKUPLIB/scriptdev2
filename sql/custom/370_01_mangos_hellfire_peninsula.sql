...
-- fix npc 16852
UPDATE creature SET DeathState = 0 WHERE id = 16852; -- apply this line once to revert wrong fix
UPDATE `creature_template` SET `dynamicflags` = `dynamicflags` | 32 WHERE entry = 16852;
