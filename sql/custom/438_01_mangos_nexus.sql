-- instance nexus fixes

-- fix creatures
UPDATE creature_template SET unit_flags = 0 WHERE entry = 26793;
UPDATE creature_template SET modelid_1=9510, modelid_3=9510 WHERE entry=26918; -- nexus anomalus model id add
...
-- update dmgvalues
UPDATE creature_template SET dmg_multiplier=35 WHERE entry IN (26794, 26763);
