...
DELETE FROM `gossip_scripts` WHERE `id` = 19998;
...
-- pet trainer
-- Quest giver gossip for pet trainer gossip menu (4783)
...
-- cooking teacher
-- correct way for cooking teacher in stormwind (id 54875 willkürlich gewählt)
...
UPDATE `gossip_menu_option` SET `action_poi_id` = 54875 WHERE `menu_id` = 421 AND `id` = 2 AND `option_text` = 'Kochkunst';
