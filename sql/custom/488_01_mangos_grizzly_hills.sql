...
-- fix quest 12231 / 12247 (TODO: some of the script seems to be already done (menu_id 65535)
	...
	DELETE FROM `gossip_menu` WHERE `entry` IN (20012,20013,20014,20015,20016) OR `text_id` IN ('12793','12794','12796','12797','12798');
	...
	('20015', '12797'),
	('20016', '12798');
	DELETE FROM `gossip_menu_option` WHERE `menu_id` IN (20012,20013,20014,20015,20016);
	...
	('20012', '0', '0', 'You are free to go Orsonn, but first tell me whats wrong with the furbolg.', '1', '1', '20013', '0', '9', '12231',  '0'),
	('20012', '1', '0', 'You are free to go Orsonn, but first tell me whats wrong with the furbolg.', '1', '1', '20013', '0', '9', '12247',  '0'),
	('20013', '2', '0', 'What happened then?', '1', '1', '20014', '0', '0', '0', '0'),
	('20014', '3', '0', 'Thank you, Son of Ursoc. I will see what can be done.', '1', '1', '20014', '122311', '9', '12231', '0'),
	('20014', '4', '0', 'Thank you, Son of Ursoc. I will see what can be done.', '1', '1', '20014', '122471', '9', '12247', '0'),
	('20015', '0', '0', 'Who was this stranger?', '1', '1', '20021', '0', '9', '12231',  '0'),
	('20015', '1', '0', 'Who was this stranger?', '1', '1', '20021', '0', '9', '12247',  '0'),
	('20016', '2', '0', 'Thank you, Kodian. I will do what I can.', '1', '1', '20016', '122312',  '9', '12231',  '0'),
	('20016', '3', '0', 'Thank you, Kodian. I will do what I can.', '1', '1', '20016', '122472',  '9', '12247',  '0');
	DELETE FROM `locales_gossip_menu_option` WHERE `menu_id` IN (20012,20013,20014,20015,20016);
	INSERT INTO `locales_gossip_menu_option` (`menu_id`,`id`,`option_text_loc3`) VALUES 
	('20012', '0', 'Sie sind frei zu gehen Orsonn, aber zuerst sagen Sie mir, was ist mit den Furbolgs passiert ist.'),
	('20012', '1', 'Sie sind frei zu gehen Orsonn, aber zuerst sagen Sie mir, was ist mit den Furbolgs passiert ist.'),
	('20013', '2', 'Was passierte dann?'),
	('20014', '3', 'Vielen Dank, Sohn von Ursoc. Ich werde sehen, was getan werden kann.'),
	('20014', '4', 'Vielen Dank, Sohn von Ursoc. Ich werde sehen, was getan werden kann.'),
	('20015', '0', 'Wer war dieser Fremde?'),
	('20015', '1', 'Wer war dieser Fremde?'),
	('20016', '2', 'Vielen Dank, Kodian. Ich werde tun was ich kann.'),
	('20016', '3', 'Vielen Dank, Kodian. Ich werde tun was ich kann.');
