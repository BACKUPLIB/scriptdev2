...
-- Updates for some ohter fixes
	UPDATE creature_template SET minhealth=28808, maxhealth=28808, ScriptName='', flags_extra=0, lootid=0, questitem1=0, unit_flags=524864 WHERE entry IN (21599, 21600);
...
-- delete scriptnames from difficulty_1 npc's
	UPDATE `creature_template` SET `ScriptName` = '' WHERE `entry` IN (21599,600);
