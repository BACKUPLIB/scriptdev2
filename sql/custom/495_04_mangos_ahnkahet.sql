...
-- boss Jedogar Shadowseeker
	...
	INSERT INTO creature (guid, id, map, spawnMask, phaseMask, modelid, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, curhealth, MovementType) VALUES
	(230014, 29310, 619, 3, 1, 26777, 372.331, -705.278, -16.1797, 5.42797, 14400, 0, 212700, 0);
	UPDATE creature_template SET MovementId=0 WHERE entry IN (29310, 31465);
	UPDATE creature_template SET unit_flags=0, mechanic_immune_mask=1073741823, speed_walk=0.7, speed_run=0.7, flags_extra=2, ScriptName='npc_twilight_volunteer', unit_flags=32768, type_flags=8 WHERE entry IN (30385);
	UPDATE creature_template SET unit_flags=0, mechanic_immune_mask=1073741823, speed_walk=0.7, speed_run=0.7, flags_extra=2, ScriptName='', unit_flags=32768, type_flags=8 WHERE entry IN (31474);
...
-- boss Amanitar
	...
	INSERT INTO creature (guid, id, map, spawnMask, position_x, position_y, position_z, orientation, spawntimesecs, spawndist, curhealth) VALUES
	(230013,30258, 619, 2, 346.342987, -894.199036, -77.352600, 1.065079, 86400, 0, 431392);
