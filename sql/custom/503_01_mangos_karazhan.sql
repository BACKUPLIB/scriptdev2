...
/* Voidzone: not attackable, not selectable, pacified, no movement, NullAI */
UPDATE `creature_template` SET `unit_flags` = 0x02020002, `type_flags` = '1026', `MovementType` = '0', `AIName` = 'NullAI' WHERE `entry` =16697;
