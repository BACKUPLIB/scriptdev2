-- trial
UPDATE `command` SET `security` = 1 WHERE `name` IN ('lookup tele','tele name','recall','showarea','hidearea','gm fly');
-- gm,mod,pr
...
'unban character','unban ip','npc textemote','mute','unmute','guild delete','quit','die',
