-- prepare ov server for wotlk release

-- set all looted emblems to emblem of heroism
UPDATE `creature_loot_template` SET `item` = 40752 WHERE entry IN (40753,45624,47241,49426);
UPDATE `gameobject_loot_template` SET `item` = 40752 WHERE entry IN (40753,45624,47241,49426);
UPDATE `reference_loot_template` SET `item` = 40752 WHERE entry IN (40753,45624,47241,49426);
UPDATE `creature_loot_template` SET `item` = 40752 WHERE entry IN (40753,45624,47241,49426);
UPDATE `item_loot_template` SET `item` = 40752 WHERE entry IN (40753,45624,47241,49426);
